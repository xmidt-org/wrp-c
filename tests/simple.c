...
void test_encode_decode()
{
	...
	CU_ASSERT_EQUAL( message->u.req.source, message->u.req.source );
	CU_ASSERT_EQUAL( message->u.req.dest, message->u.req.dest );
	CU_ASSERT_EQUAL( message->u.req.transaction_uuid, message->u.req.transaction_uuid );
	CU_ASSERT_EQUAL( message->u.req.payload, message->u.req.payload );
