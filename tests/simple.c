...
void test_encode_decode()
{
    ...
    processCreateRequest( void * argc, void * argv ); //TODO arguments has to updated
    processRetrieveRequest( void * userData, void * argv ); //TODO arguments has to updated
    processUpdateRequest( void * argc, void * argv ); //TODO arguments has to updated
    processDeleteRequest( void * argc, void * argv ); //TODO arguments has to updated
    free( bytes );
    CU_ASSERT_EQUAL( rv, size );
    CU_ASSERT_EQUAL( message->msg_type, msg.msg_type );
    CU_ASSERT_STRING_EQUAL( message->u.req.source, msg.u.req.source );
