...
const struct test_vector test = {
    ...
    .in.u.crud.rdr.num                = (int*)&(test.in.u.crud.rdr.__internal_only),
    .in.u.crud.rdr.__internal_only    = 12,
    .in.u.crud.session_id.s           = "bebc43de-501b-4435-a8b1-8a4d174a1a91",
    .in.u.crud.session_id.len         = 36,
    .in.u.crud.status.num             = (int*)&(test.in.u.crud.status.__internal_only),
    .in.u.crud.status.__internal_only = 19,
